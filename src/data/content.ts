...
export const services = [
  ...
  },
  {
    ...
    description: "Flujos que eliminan tareas repetitivas (seguimiento de clientes, recordatorios, integraciones entre herramientas).",
    target: "Equipos que pierden horas en procesos manuales.",
    icon: "cog"
  },
  {
  ...
  {
    id: "extraccion-datos",
    title: "Extracción de datos y digitalización",
    description: "Convertir información dispersa (boletas, hojas de cálculo, PDFs, sistemas antiguos) en datos estructurados y utilizables.",
    target: "Negocios con información desordenada o en papel.",
    icon: "database"
  },
  {
    id: "dashboards",
...
export const processSteps = [
  {
    ...
    description: "15 minutos para entender cómo manejas hoy tus ventas y dónde estás perdiendo tiempo o dinero."
  },
  {
    number: "2",
    title: "Propuesta simple",
    description: "Una página, sin tecnicismos: qué hacemos, qué incluye, cuánto cuesta y en cuánto tiempo lo tienes listo."
  },
  {
    number: "3",
    title: "Implementación",
    description: "Construimos e integramos todo en 7 a 14 días, según el servicio elegido."
  },
  {
    number: "4",
    title: "Acompañamiento",
    description: "Te capacitamos en el uso y seguimos ajustando según lo que veas funcionar mejor en tu negocio."
  }
];
